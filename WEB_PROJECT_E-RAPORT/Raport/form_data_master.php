...
//form data pelajaran
	...
	elseif ($_GET['kode']=="kelas_insert"){
		//pemanggilan fungsi penambahan
		$a="SELECT * FROM kelas";
		$b="SELECT inc FROM kelas ORDER BY inc DESC LIMIT 1";
		$inc=penambahan($a, $b);
	echo "<div class='row-fluid sortable'>
				<div class='box span12'>
					<div class='box-header' data-original-title>
					...
					<div class='box-content'>
						<form class='form-horizontal'>
						  ...
						  <input type=hidden name=inc id=inc value=$inc />
							...
							<input type='text' name=kelas_Kode class='span6 typeahead' id='typeahead' value='KELAS-$inc'>
							</div>
							...
							<input type='text' name=nmkelas class='span6 typeahead' id='typeahead'>
							</div>
    ...
    echo "<div class='row-fluid sortable'>
				<div class='box span12'>
                  ...
                  <?php
						...
						$qjurusan=mysqli_query($koneksi, $jurusan);
...
//form data wali kelas
	elseif($_GET['kode']=="walikelas_insert"){
		//pemanggilan fungsi penambahan
		$a="SELECT * FROM wali_kelas";
		$b="SELECT inc FROM wali_kelas ORDER BY inc DESC LIMIT 1";
		$inc=penambahan($a, $b);
    echo "<div class='row-fluid sortable'>
				<div class='box span12'>
					<div class='box-header' data-original-title>
					...
					<div class='box-content'>
						<form class='form-horizontal'>
						  ...
						  <input type=hidden name=walikelas_inc id=walikelas_inc value=$inc />
							...
							<div class='controls'>";
							?>
							<select name="pilih_kelas" data-placeholder="" id="selectError2" data-rel="chosen">
                  ...
                  <?php
						...
						{
							echo "<option value='$dkelas[kelas_id]'>$dkelas[kelas_nama]</option>";
						}
					?>
  			      </select>
							<?php
